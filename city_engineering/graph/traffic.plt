...
#set xtics "1997/01/01",31536000*5,"2050/12/01"
#set mxtics 2
#set ytics -1000,10000,100000
#set mytics 2
#set xtics "1997/01/01",31536000*3,"2030/12/01"
#set mxtics 2
#set ytics -1000,10000,100000
#set mytics 2
set xtics "1997/01/01",31536000*2,"2020/12/01"
set mxtics 2
...
x2=1.5*10**(8)
f2(x)=a2*exp(b2*(x-x2))
fit f2(x) "traffic.dat" via a2,b2,x2
...
fit f4(x) "traffic.dat" via a4,b4,c4
