...
<Properties>
  <View=-154,139,1133,1142,1,0,0>
  <Grid=10,10,1>
  <DataSet=ex2-A-1.dat>
  <DataDisplay=ex2-A-1.dpl>
  <OpenDisplay=1>
  <Script=ex2-A-1.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <Vdc V2 1 180 770 18 -26 0 1 "-0.5 V" 1>
  <GND * 1 780 660 0 0 0 0>
  <GND * 1 410 740 0 0 0 0>
  <R R1 1 300 570 -26 15 0 0 "9.98 kOhm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <C C1 1 440 470 -26 -55 1 0 "0.103 uF" 1 "0" 0 "neutral" 0>
  <.TR TR1 1 390 890 0 66 0 0 "lin" 1 "0.4" 1 "0.4125 s" 1 "5001" 0 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
  <Eqn Eqn2 1 1010 510 -23 19 0 0 "MIN(V_o.Vt)=1" 1 "yes" 0>
</Components>
<Wires>
